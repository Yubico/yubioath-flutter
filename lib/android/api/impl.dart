...
class OathApi {
  ...
  Future<void> setPassword(String arg_newPassword) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.OathApi.setPassword', codec, binaryMessenger: _binaryMessenger);
    final Map<Object?, Object?>? replyMap =
        await channel.send(<Object>[arg_newPassword]) as Map<Object?, Object?>?;
    if (replyMap == null) {
      throw PlatformException(
        code: 'channel-error',
        message: 'Unable to establish connection on channel.',
  ...
  Future<void> changePassword(String arg_currentPassword, String arg_newPassword) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.OathApi.changePassword', codec, binaryMessenger: _binaryMessenger);
    final Map<Object?, Object?>? replyMap =
  ...
  Future<String> renameAccount(String arg_uri, String arg_name) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.OathApi.renameAccount', codec, binaryMessenger: _binaryMessenger);
    final Map<Object?, Object?>? replyMap =
        await channel.send(<Object>[arg_uri, arg_name]) as Map<Object?, Object?>?;
    if (replyMap == null) {
      throw PlatformException(
        code: 'channel-error',
        message: 'Unable to establish connection on channel.',
  ...
  Future<String> renameAccountWithIssuer(String arg_uri, String arg_name, String arg_issuer) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.OathApi.renameAccountWithIssuer', codec, binaryMessenger: _binaryMessenger);
    final Map<Object?, Object?>? replyMap =
