...
Pane {
    ...
    function deleteCard() {
        navigator.confirm(
                    ...
                    qsTr("This will permanently delete the credential from the YubiKey, and your ability to generate codes for it. Make sure 2FA has been disabled before proceeding."),
                    function () {
                        if (settings.otpMode) {
