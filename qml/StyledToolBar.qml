...
ToolBar {
    ...
    property bool showTitleLbl: !!navigator.currentItem && !!navigator.currentItem.title
    ...
    function shouldShowSearch() {
        return !!(navigator.currentItem && navigator.currentItem.objectName === "credentialsView" && entries.count > 0) || !!(navigator.currentItem && navigator.currentItem.objectName === "settingsView");
    }

    function shouldShowSettings() {
        return !!(navigator.currentItem && navigator.currentItem.objectName !== "settingsView" && navigator.currentItem.objectName !== "newCredentialView");
    }
    ...
    function shouldShowCredentialOptions() {
        return !!(app.currentCredentialCard && navigator.currentItem && navigator.currentItem.objectName === "credentialsView");
    }
    ...
    RowLayout {
        ...
        ToolButton {
            ...
            TextField {
                ...
                placeholderText: !!(navigator.currentItem && navigator.currentItem.objectName !== "settingsView") ? qsTr("Search accounts") : qsTr("Search settings")
                ...
                KeyNavigation.tab: shouldShowCredentialOptions() ? copyCredentialBtn : addCredentialBtn
                KeyNavigation.right: shouldShowCredentialOptions() ? copyCredentialBtn : addCredentialBtn
        ...
        RowLayout {
            ...
            ToolButton {
                ...
                visible: !!yubiKey.currentDevice && yubiKey.currentDeviceValidated && navigator.currentItem && navigator.currentItem.objectName === "credentialsView"
                Layout.alignment: Qt.AlignRight | Qt.AlignVCenter
